...
export default function RootLayout({
  ...
  return (
    <html lang="es-ar" className="!scroll-smooth">
      ...
      >
        <div className="bg-[#b700ff55] absolute top-[24rem] right-[14rem] -z-5 h-[31rem] w-[44rem] rounded-full blur-[18rem] max-sm:h-[20rem] max-sm:right-[4rem] max-sm:top-[12rem] sm:w-[44rem] sm:h-[20rem] dark:blur-[12rem] dark:bg-[#cd8486d1]/70"></div>
        ...
        <div className="bg-[#f6cdd6] absolute top-[24rem] left-[-38rem] -z-5 h-[31rem] w-[44rem] rounded-full blur-[12rem] max-sm:hidden sm:w-[48rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-10rem] 2xl:left-[8rem] dark:bg-[#cd8486d1]/90"></div>
